...
public class ChibaRotate : MonoBehaviour {
    ...
    public GameObject cameraChiba;   /*!< Variable for the camera */
     ...
     */
	void Update () {
        rotateChiba.eulerAngles = new Vector3(transform.rotation.eulerAngles.x, cameraChiba.transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.x);
