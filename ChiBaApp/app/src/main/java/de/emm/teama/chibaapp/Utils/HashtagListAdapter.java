...
/**
 *  <h1>HashtagListAdapter Class</h1>
 * This class handles the list used to show assigned hashtags.
 * <p>
...
public class HashtagListAdapter extends ArrayAdapter<String>{
    private static final String TAG = "HashtagListAdapter";
     ...
     */
    public HashtagListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<String> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView hashtagText = (TextView) convertView.findViewById(R.id.textViewHashtagList);
